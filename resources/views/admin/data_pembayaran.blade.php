          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                  ...
                  <input type="search" name="search" class="form-control" placeholder="Search products" id="search">
                      ...
                      <table class="table">
                        ...
                        @foreach($pembayaran as $b)
                          ...
                          <td> {{$b->id_order}} </td>
                            ...
                            <td> {{$b->tanggal_order}} </td>
                        
                            
                            <td>
                                @if($b->status=='process' || $b->status==null)
                            <a href="{{url('lunas',$b->id_order)}}"class="badge badge-outline-success">Acc</a>
